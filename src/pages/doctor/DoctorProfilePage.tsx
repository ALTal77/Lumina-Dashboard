      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          <div>
            <label className="block font-semibold text-muted mb-1">
              {t("doctorProfilePage.form.doctorName")}
            </label>
            <input
              type="text"
              value={name}
          ...
          <div>
            ...
            <input
              ...
              disabled
              value={user.email}
              className="w-full p-2.5 bg-neutral-bg border border-border rounded-xl text-muted cursor-not-allowed"
            />
          </div>
        </div>
        ...
        <div>
          <label className="block text-xs font-semibold text-muted mb-1">
            {t("doctorProfilePage.form.professionalBio")}
          </label>
          <textarea
            rows={3}
            value={bio}
        ...
        <div className="pt-2">
          <FileUploadMock label={t("doctorProfilePage.form.fileUploadLabel")} />
        </div>
